...
```{r}
#Reading the data
smoking_prevalence <- read.csv("IHME_GBD_2015_SMOKING_PREVALENCE_1980_2015_Y2017M04D05.CSV")
```
...
For the plot part I got inspired by this [code](https://github.com/AmierohAbrahams/Exegetic/blob/master/Assignment.R) with modifications.
